...
describe('TaskListComponent', () => {
  ...
  it('should render script-like task title as text without creating a script element', () => {
    component.tasks = [
      {
        taskId: 1,
  ...
  it('should render script-like task description as text without creating a script element', () => {
    component.tasks = [
      {
        taskId: 1,
        title: 'Task with script-like description',
